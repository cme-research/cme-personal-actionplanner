...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-dev-only-k^!u5+fh#s!)i26ex^y%!+a$g93n0il$rcb4$n(cv-qe31wzuk",
)
...
MIDDLEWARE = [
    ...
    "actionplanner.middleware.LoginRequiredMiddleware",
]

ROOT_URLCONF = "actionplanner.urls"
